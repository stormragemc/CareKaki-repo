      ...
      {chatOpen && (
        <aside className="w-96 border-l border-gray-200 bg-gray-50 flex flex-col shrink-0">
          <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
            ...
            <button onClick={() => setChatOpen(false)} className="text-gray-400 hover:text-gray-700 text-sm">✕</button>
          </div>
          ...
          <div className="px-4 py-3 border-t border-gray-200">
            ...
            <p className="text-[10px] text-gray-400 mt-1.5">Each edit uses 1 OpenAI API call</p>
          </div>
        </aside>
      )}
    </div>
